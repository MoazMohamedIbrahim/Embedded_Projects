...
; This file was generated Sat Aug 18 15:23:26 2018
;--------------------------------------------------------
...
r0x1005	res	1
r0x1004	res	1
_Delay_MS_x_1_3	res	2
_Delay_MS_y_1_3	res	2
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------
;--------------------------------------------------------
...
;; ***	genAssign  6928
;; ***	aopForSym 315
;;	327 sym->rname = _Delay_MS_x_1_3, size = 2
;; 	line = 6937 result AOP_DIR=_Delay_MS_x_1_3, size=2, left -=-, size=0, right AOP_LIT=0x00, size=2
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _Delay_MS_x_1_3   offset=0
	.line	9; "Util.c"	for (x = 0; x <= delay; x++){
	BANKSEL	_Delay_MS_x_1_3
	CLRF	_Delay_MS_x_1_3
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _Delay_MS_x_1_3   offset=1
	CLRF	(_Delay_MS_x_1_3 + 1)
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
;; ***	genLabel  2763
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; ***	genAssign  6928
;; ***	aopForSym 315
;;	327 sym->rname = _Delay_MS_y_1_3, size = 2
;; 	line = 6937 result AOP_DIR=_Delay_MS_y_1_3, size=2, left -=-, size=0, right AOP_LIT=0x00, size=2
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _Delay_MS_y_1_3   offset=0
	.line	10; "Util.c"	for (y = 0; y <= 120; y++);
	BANKSEL	_Delay_MS_y_1_3
	CLRF	_Delay_MS_y_1_3
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _Delay_MS_y_1_3   offset=1
	CLRF	(_Delay_MS_y_1_3 + 1)
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
;; ***	genLabel  2763
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; ***	aopForSym 315
;;	327 sym->rname = _Delay_MS_y_1_3, size = 2
;; 	line = 618 result AOP_DIR=_Delay_MS_y_1_3, size=2, left AOP_DIR=_Delay_MS_y_1_3, size=2, right AOP_LIT=0x01, size=1
...
;; ***	aopForSym 315
;;	327 sym->rname = _Delay_MS_x_1_3, size = 2
;; 	line = 618 result AOP_DIR=_Delay_MS_x_1_3, size=2, left AOP_DIR=_Delay_MS_x_1_3, size=2, right AOP_LIT=0x01, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
;; 	result AOP_DIR, left AOP_DIR, right AOP_LIT
;; 	genPlusIncr  156
...
_00112_DS_
	.line	9; "Util.c"	for (x = 0; x <= delay; x++){
	BANKSEL	_Delay_MS_x_1_3
	INCF	_Delay_MS_x_1_3,F
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:172:genPlusIncr
	BTFSC	STATUS,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:173:genPlusIncr
;;	1009
;;	1028  _Delay_MS_x_1_3   offset=1
	INCF	(_Delay_MS_x_1_3 + 1),F
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2778:genGoto *{*
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2780:genGoto
